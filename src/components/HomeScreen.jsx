...
export default function HomeScreen({ onStartGame, playerStats, discoveredSpecies }) {
  ...
  return (
    <div className="home-screen">
      <div className="home-background">
        ...
        <div className="content-container">
          <div className="title-section">
            <h1 className="main-title">ROV MARINA</h1>
            <p className="subtitle">Explora las profundidades del océano</p>
            <p className="description">Sumérgete en una aventura submarina única. Controla tu ROV y descubre las maravillas ocultas en las profundidades del mar.</p>
          </div>
      ...
      <SpeciesAlbum 
        isOpen={showSpeciesAlbum}
        onClose={() => setShowSpeciesAlbum(false)}
